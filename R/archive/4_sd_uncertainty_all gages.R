...
#create string of gage IDs to run code
gage <- gages$site_no
...
#clean up data frames (remove errors like -99999 for NO3)

ts <- ts %>% filter(NO3_ppm >= 0) %>%
  filter(Q_cfs >=0)

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#3.0 Create function to run for all gages -------------------
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

gage_fun <- function(gage){


#3.1 Develop Error Distributions -----------------------------------------------
...
#3.2 Cascade Error distribution through hydrograph -----------------------------

#Subset ts to gage and time period of interest
ts_gage<-ts %>% 
  filter(site_no==gage) %>% 
...
#3.3 Resample Error Distribution -----------------------------------------------
...
#Estimate cumulative annual load 
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#4.0 Run Function for all gages----------------------------------------------
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#write CSV
write.csv(gage_est,"data/Gage Estimate Output_SLS_4-21-22.csv")
